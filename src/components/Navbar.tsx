      ...
      <nav className="max-w-7xl mx-auto flex items-center justify-between px-6 py-3 rounded-2xl md:rounded-full glass-panel glass-panel-hover transition-all duration-500 shadow-[0_8px_32px_0_rgba(3,2,8,0.5)]">
        <div className="flex items-center gap-3">
          <div className="relative group cursor-pointer">
            <div className="absolute inset-0 bg-linear-to-tr from-neon-purple to-neon-cyan rounded-lg blur opacity-75 group-hover:opacity-100 transition-opacity duration-300" />
            <div className="relative w-10 h-10 bg-cyber-bg border border-white/10 rounded-lg flex items-center justify-center font-bold text-xl overflow-hidden">
              <span className="bg-linear-to-r from-neon-purple to-neon-cyan bg-clip-text text-transparent font-extrabold font-display">
                DK
              </span>
        ...
        <div className="hidden md:flex items-center gap-5">
          ...
          >
            ...
            <div className="absolute inset-0 -z-10 bg-linear-to-r from-neon-purple/10 to-neon-cyan/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          </a>
        </div>
        ...
        >
          ...
          <div className="flex items-center justify-between pt-2">
            ...
            <a
              ...
              className="flex items-center gap-2 px-5 py-2 text-xs font-semibold rounded-full border border-white/15 bg-linear-to-r from-neon-purple/20 to-neon-cyan/20"
            >
