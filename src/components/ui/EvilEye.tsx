...
export default function EvilEye({
  ...
  useEffect(() => {
    ...
    let program: Program;
    const baseEyeVec = hexToVec3(eyeColor);
    ...
    // style canvas to occupy the container fully
    ...
    function update(time: number) {
      ...
      // animate green and blue channels smoothly around base color
      const t = time * 0.001;
  ...
  }, [eyeColor, intensity, pupilSize, irisWidth, glowIntensity, scale, noiseScale, pupilFollow, flameSpeed, backgroundColor, colorAnimSpeed, colorAnimAmplitude]);
