...
export default function GlowBackground() {
  ...
  return (
    <div className="fixed inset-0 z-0 w-full h-full overflow-hidden select-none pointer-events-none bg-[#000105]">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_72%_25%,rgba(142,58,255,0.28)_0%,rgba(43,40,114,0.16)_22%,transparent_48%),radial-gradient(circle_at_76%_28%,rgba(74,115,255,0.24)_0%,transparent_38%),radial-gradient(circle_at_26%_22%,rgba(109,40,217,0.14)_0%,transparent_40%),linear-gradient(180deg,#02020a_0%,#03020d_34%,#020208_58%,#000000_100%)]" />

      <div className="absolute inset-0 opacity-[0.18] mix-blend-screen bg-grid-pattern animate-grid-move mask-[radial-gradient(circle_at_center,black_40%,transparent_85%)]" />

      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,rgba(0,0,0,0.15)_42%,rgba(0,0,0,0.7)_100%)]" />

      <div className="absolute inset-x-0 top-0 h-[58vh]">
      ...
      <div className="absolute inset-x-0 top-0 h-[78vh] opacity-70">
      ...
      <div className="absolute inset-x-0 bottom-0 h-[30vh] bg-linear-to-t from-black via-black/85 to-transparent" />
    </div>
  )
}
